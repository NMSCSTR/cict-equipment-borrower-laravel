...
<div id="add-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
    <div class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4">
        ...
        <form id="add-form" action="{{ route('admin.equipment.store') }}" method="POST" class="p-6 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label for="add-quantity" class="block text-sm font-medium text-gray-700 mb-1">Total
                        Quantity</label>
                ...
                <div>
                    <label for="add-available" class="block text-sm font-medium text-gray-700 mb-1">Available
                        Quantity</label>
            ...
            <div>
                <label for="add-status" class="block text-sm font-medium text-gray-700 mb-1">Status</label>
            ...
            <div class="px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
                <button type="button" id="cancel-add"
                    class="px-4 py-2 text-gray-600 hover:text-gray-800 font-medium">Cancel</button>
                <button type="submit"
                    class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 font-medium transition-colors duration-200">Add
                    Equipment</button>
            </div>
        </form>
    </div>
